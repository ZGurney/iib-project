...
class GPGeneratorShiftedClassification:
    ...
    def generate_batch(self):
        ...
        return {
            ...
            "x_context_reg": x_context_reg,

            "y_context_reg": splits[0],

            "x_context_class": x_context_class,

            "y_context_class": to_class(splits[1]),

            "x_target_reg": x_target_reg,

            "y_target_reg": splits[2],

            "x_target_class": x_target_class,

            "y_target_class": to_class(splits[3]),
