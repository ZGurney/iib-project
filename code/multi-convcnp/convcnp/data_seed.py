...
class GPGenerator2:
    ...
    def generate_batch(self):
        ...
        with B.on_device(self.device):
            ...
            B.epsilon = 1e-5 # Strong regularisation

            #x_dense = B.linspace(torch.float32, *self.x_range, 200)
            #discard_state, y_dense = stheno.GP(self.kernel)(x_dense, noise).sample(self.state)
